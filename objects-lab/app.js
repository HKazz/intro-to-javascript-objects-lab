...
const game = {
  ...
  console.log(game)
  // game.party will hold any array of pokemon objects that will be retrieved from pokemon array. these are the pokemon that are caught
  // game.gyms holds an array of objects representing a gym
  // game.items holds an array of objects each representing an item in the player's inventory
...
// exercise 5
pokemon.forEach(pokemon => {
  if(pokemon.type === 'electric' && pokemon.hp >= 90){
    game.party.push(pokemon)
  }
});
...
console.log(game.gyms[0].completed)
console.log(game.gyms[1].completed)
console.log(game.gyms[2].completed)
console.log(game.gyms[3].completed)
